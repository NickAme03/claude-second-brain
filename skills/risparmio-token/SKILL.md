...
- se l'audit rivela istruzioni da spostare da CLAUDE.md a una skill nuova → **skill-creator** (crearla con progressive disclosure già impostata)
- se la skill nuova esiste e va messa in rete → **skill-linker** (collegarla al grafo)
- se le raccomandazioni dell'audit verranno usate per decisioni con costi reali → **verifica-rigore** (controllo avversariale dei numeri prima di agire)
